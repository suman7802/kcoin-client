        ...
        <Card>
            <CardHeader>
                <div className="flex items-center justify-between">
                    <div>
                        ...
                        <CardDescription>View the blockchain with pagination and filters</CardDescription>
                    </div>
            ...
            <CardContent>
                {isLoading ? (
                    ...
                    <p className="text-sm text-destructive text-center py-8">Failed to load blockchain</p>
                ) : blocks.length === 0 ? (
                        ...
                        {pagination && (
                            <div className="flex items-center justify-between mt-6 pt-4 border-t">
                                <div className="text-sm text-muted-foreground">
                                    Page {pagination.currentPage} of {pagination.totalPages} ({pagination.totalCount} total blocks)
                                </div>
                                <div className="flex gap-2">
                                    <Button
                                        variant="outline"
